...
//    private var dataSource: UICollectionViewDiffableDataSource<DetailViewSection, Charac>?
...
//    private func infoRegisterCells() -> UICollectionView.CellRegistration<InfoCollectionViewCell, Charac> {
